#!/bin/bash
#===============================================
# Description: 2305_x64_wjq DIY script part 2
# File name: 2305_x64_wjq_diy-part2.sh
# Lisence: MIT
# By: GXNAS
#===============================================
...
# 修改右下角脚本版本信息
sed -i 's/<a class=\"luci-link\" href=\"https:\/\/github.com\/openwrt\/luci\" target=\"_blank\">Powered by {{ version.luciname }} ({{ version.luciversion }})<\/a>/OpenWrt_2305_x64_主路由版 by GXNAS build @R'"$build_date"'/' package/luci-theme-argon/ucode/template/themes/argon/footer.ut
...
# 修改登录页版本信息
sed -i "/luci-link/d; s|<a href=\"https://github.com/jerrykuku/luci-theme-argon\" target=\"_blank\">ArgonTheme {# vPKG_VERSION #}</a>|OpenWrt_2305_x64_主路由版 by GXNAS build @R$build_date|" package/luci-theme-argon/ucode/template/themes/argon/footer_login.ut
